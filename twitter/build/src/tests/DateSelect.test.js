...
const FormSelect = () => {
    ...
    return (_jsx(Provider, { store: store, children: _jsx(ThemeProvider, { theme: lightTheme, children: _jsx(DateSelect, { control: control }) }) }));
};
describe("DateSelect", () => {
    test("should render correct options", async () => {
        const { getByText, findAllByText, getAllByTestId, queryAllByText } = render(_jsx(FormSelect, {}), {
    ...
    test("should render correct not leap year days", async () => {
        const { getByText, findAllByText, queryAllByText } = render(_jsx(FormSelect, {}), {
            wrapper: MemoryRouter,
        });
        const monthSelect = getByText("Month");
        const daySelect = getByText("Day");
